...
bqhumidité = [
    {"theme" : "humidite", "question" : "Quel est l'élément le plus important en météo?", "réponse" : "La vapeur d'eau", "indice" : ""},
    {"theme" : "humidite", "question" : "Le point de rosée augmente si l'air est...", "réponse" : "chaud", "indice" : ""},
    {"theme" : "humidite", "question" : "Qu'est-ce que le point de rosée?", "réponse" : "La température à pression constante à laquelle si l'air doit être refroidi pour qu'il y ait saturation", "indice" : ""},
    {"theme" : "humidite", "question" : "Que fait l'eau lorsqu'elle est dans l'air et devient liquide?", "réponse" : "Elle donne son énergie à l'air, ce qui augmente la température de l'air", "indice" : "Elle "},
    {"theme" : "humidite", "question" : "Que fait l'eau liquide lorsqu'elle est dans l'air et devient gazeux?", "réponse" : "Elle prend de l'énergie à l'air, ce qui diminue la température de l'air", "indice" : "Elle "},
    {"theme" : "humidite", "question" : "Que'est-ce que l'humidité relative?", "réponse" : "La quantité d'eau contenu dans l'air par rapport à ce qu'elle pourrait contenir", "indice" : ""},
    {"theme" : "humidite", "question" : "Quels sont les trois faccteurs qui affectent négativement les performances?", "réponse" : "Une haute température, une basse pression et une haute humidité", "indice" : "Une , une  et une "},
    {"theme" : "humidite", "question" : "Quel est l'élément essentiel qu'il doit y avoir dans l'atmosphère pour qu'il y ait de la condentation?", "réponse" : "Des noyaux de condensation", "indice" : "Des "},
]

bqréchauffement = [
    {"theme" : "rechauffement", "question" : "Quel est la température qui définit la tropopause?", "réponse" : "-56", "indice" : ""},
    {"theme" : "rechauffement", "question" : "Quels sont les quatre couches de l'atmosphère?", "réponse" : "La troposphère, la mésosphère, la stratosphère et la thermosphère", "indice" : "La , la , la  et la "},
    {"theme" : "rechauffement", "question" : "Quel type d'onde nous envoie le Soleil (2 lettres) et quel est sa longueur d'onde?", "réponse" : "UV et courte", "indice" : " et "},
    {"theme" : "rechauffement", "question" : "Qu'est-ce que la réflexion Albédo?", "réponse" : "Lorsque les rayons touchent la Terre perpendiculairement, ils sont plus puissants que ceux tangents", "indice" : ""},
    {"theme" : "rechauffement", "question" : "Quels sont les trois propriété de l'air?", "réponse" : "Mobilité, capacité d'expansion et capacité de compression", "indice" : " ,  et "},
    {"theme" : "rechauffement", "question" : "Comment se nomme le sommet de la troposphère?", "réponse" : "La tropopause", "indice" : "La "},
    {"theme" : "rechauffement", "question" : "Comment se nomme le sommet de la stratosphère?", "réponse" : "La stratopause", "indice" : "La "},
    {"theme" : "rechauffement", "question" : "Comment se nomme le sommet de la mésosphère?", "réponse" : "La mésopause", "indice" : "La "},
    {"theme" : "rechauffement", "question" : "Où est l'endroit où la tropopause est la plus basse?", "réponse" : "Aux pôles", "indice" : ""},
    {"theme" : "rechauffement", "question" : "Dans quel partie de l'atmosphère est-ce que la température diminue avec l'altitude qui augmente?", "réponse" : "La troposhère", "indice" : "La "},
    {"theme" : "rechauffement", "question" : "Est-il possible de retrouver des nuages à de rares occasions dans la stratosphère?", "réponse" : "Oui", "indice" : ""},
    {"theme" : "rechauffement", "question" : "Dans quel partie est-ce que la température se stabilise et augmente légèrement?", "réponse" : "La stratosphère", "indice" : "La "},
    {"theme" : "rechauffement", "question" : "Quel est la partie de l'atmosphère la plus froide?", "réponse" : "La mésosphère", "indice" : "La "},
    {"theme" : "rechauffement", "question" : "Dans quel partie de l'atmosphère est-ce que les particules sont les plus chaudes?", "réponse" : "La thermosphère", "indice" : "La "},
    {"theme" : "rechauffement", "question" : "Dans quel couche de l'atmosphère est-ce qu'il y a les aurores boréales et où se promène l'ISS?", "réponse" : "La thermosphère", "indice" : "La "},
    {"theme" : "rechauffement", "question" : "Le sol transforme quel type d'onde en quel type d'onde?", "réponse" : "Des ondes UV et ondes infra-rouge", "indice" : "Des ondes  en ondes "},
    {"theme" : "rechauffement", "question" : "Lequel se réchauffe et se refroidit le plus vite, l'eau ou la terre?", "réponse" : "La terre", "indice" : "L"},
    {"theme" : "rechauffement", "question" : "Comment se nomme le procéssus où l'air se réchauffe dû aux propritétés de l'air qui fait en sorte que celle-ci monte si elle est chaude et descend si celle-ci est froide?", "réponse" : "Convection", "indice" : ""},
    {"theme" : "rechauffement", "question" : "Comment se nomme le procéssus où l'air se réchauffe dû aux interférence du terrain, et fait en sorte que l'air se mélange?", "réponse" : "Mélange turbulent", "indice" : ""},
    {"theme" : "rechauffement", "question" : "Comment se nomme le procéssus où l'air se réchauffe dû au contact avec le sol?", "réponse" : "Conduction", "indice" : ""},
    {"theme" : "rechauffement", "question" : "Comment se nomme le procéssus où l'air se réchauffe dû à l'eau qui donne de son énergie pour se condenser?", "réponse" : "Dégagement de chaleur latente", "indice" : ""},
    {"theme" : "rechauffement", "question" : "Comment se nomme le procéssus où l'air se réchauffe dû au mouvement latérale de l'air au dessus d'une surface chaude?", "réponse" : "Advection", "indice" : ""},
    {"theme" : "rechauffement", "question" : "Comment se nomme le procéssus où l'air se réchauffe dû à l'air qui est forcé de descendre d'altitude?", "réponse" : "Compression", "indice" : ""},
    {"theme" : "rechauffement", "question" : "Comment se nomme, en Amérique du Nord, le phénomène où une masse d'air froide est compressée vers le bas par une autre et ceratines autres conditions sont respectées?", "réponse" : "Chinook", "indice" : ""},
]

bqrefroidissement = [
    {"theme" : "refroidissement", "question" : "Comment ce nomme le concept qui définit que la température diminue de 1,98°C par 1000 pi?", "réponse" : "Le gradient thermique vertical", "indice" : ""},
    {"theme" : "refroidissement", "question" : "Comment ce nomme le concept qui définit que la température diminue de 3°C par 1000 pi?", "réponse" : "Le gradient adiabatique sec", "indice" : ""},
    {"theme" : "refroidissement", "question" : "À quel rythme est-ce que le gradient adiabatique saturé diminue?", "réponse" : "1,5°C par 1000 pi", "indice" : " °C par 1000 pi"},
    {"theme" : "refroidissement", "question" : "À quel rythme est-ce que le gradient adiabatique saturé chaud diminue?", "réponse" : "1,1°C par 1000 pi", "indice" : " °C par 1000 pi"},
    {"theme" : "refroidissement", "question" : "À quel rythme est-ce que le gradient adiabatique saturé froid diminue?", "réponse" : "2,8°C par 1000 pi", "indice" : " °C par 1000 pi"},
    {"theme" : "refroidissement", "question" : "Quels sont les 6 processus de refroidissement? (Sans déterminant)", "réponse" : "Ascendance orographique et de pente, turbulence mécanique, convection, évaporation, advection et soulévement à grande échelle", "indice" : ", , , ,  et "},
    {"theme" : "refroidissement", "question" : "Que fait l'air lorsqu'il y a une inversion?", "réponse" : "L'air ne se refroidit plus avec l'altitude", "indice" : "L'air "},
]

metar = [
    {"theme" : "metar_et_speci", "question" : "Les metars sont émis quand?", "réponse" : "Ils sont émis au début de chaque heure", "indice" : "Ils sont émis au "},
    {"theme" : "metar_et_speci", "question" : "Si les vents sont variable, la direction des vents sera donner si la vitesse est supérieur à ___ KT?", "réponse" : "3", "indice" : ""},
    {"theme" : "metar_et_speci", "question" : "Quels sont les critères pour que la RVR soit donnée dans le metar?", "réponse" : "La visibilité de la piste en service est inférieur à 6000 pi ou la visibilité est inférieur à 1 SM", "indice" : ""},
    {"theme" : "metar_et_speci", "question" : "Quels sont les trois abréviations qui représentent des plafonds?", "réponse" : "BKN, OVC et VV", "indice" : ",  et "},
    {"theme" : "metar_et_speci", "question" : "CLR signifie qu'il n'y a aucun nuage sous quel altitude?", "réponse" : "25000 pi", "indice" : " pi"},
    {"theme" : "metar_et_speci", "question" : "Le cisaillement de vent est donnée si il est...?", "réponse" : "inférieur à 1600 pi AGL", "indice" : ""},
    {"theme" : "metar_et_speci", "question" : "Quels sont les 8 éléments qui feront qu'un speci sera émis?", "réponse" : "Variation du plafond, de l'état du ciel, de la visibilité, tornade, trombe marine ou nuage en entonnoir, orage, précipitations, vent et température", "indice" : "Variation du , de , de , , , ,  et "},
    {"theme" : "metar_et_speci", "question" : "Quel est le critère pour qu'un speci soit émis, au niveau du vent?", "réponse" : "Il double est dépasse 30 KT", "indice" : "Il "},
    {"theme" : "metar_et_speci", "question" : "Quels sont les ciritères pour qu'un speci soit émis, au niveau de la température? (Sans unité de mesure)", "réponse" : "Elle augmente de 5 et elle était à 20 et plus avant ou elle diminue de 2 ou moins", "indice" : "Elle "},
    {"theme" : "metar_et_speci", "question" : "Qu'est-ce que l'AWOS donne? (Sans déterminant)", "réponse" : "Vent, calage altimétrique, température, point de rosée, visibilité, hauteur des nuages, nébulosité, fréquences et types de précipisations, précipitations totales et givrage", "indice" : ""},
    {"theme" : "metar_et_speci", "question" : "VCTS correspond à une disatance de combien de NM de l'aéroport?", "réponse" : "5 à 10 NM", "indice" : " à  NM"},
    {"theme" : "metar_et_speci", "question" : "DIST correspond à une disatance de combien de NM de l'aéroport?", "réponse" : "10 à 30 NM", "indice" : " à  NM"},
    {"theme" : "metar_et_speci", "question" : "Les AWOS et LWIS donne l'altitude-densité si elle est supérieur ou inférieur d'au moins ___ pi par rapport à l'altitude de l'aérodrome?", "réponse" : "200", "indice" : ""},
    {"theme" : "metar_et_speci", "question" : "Que donne les LWIS? (Sans déterminant)", "réponse" : "vent, calage altimétrique, température et point de rosée", "indice" : ""},
    {"theme" : "metar_et_speci", "question" : "Que'est-ce que le VIRGA?", "réponse" : "De précipitations qui ne touchent pas le sol", "indice" : "Des "},
    {"theme" : "metar_et_speci", "question" : "Quel est la visibilité maximale d'un AWOS?", "réponse" : "9 SM", "indice" : ""},
]

taf_atis = [
    {"theme" : "TAF_et_ATIS", "question" : "Un TAF donne des prévisions pour une zone ayant un rayon de ___ NM?", "réponse" : "5", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "Il sera mentionné OFFSITE sur un TAF si la station météorologique est à ___ ___ de l'aéroport?", "réponse" : "3 KM", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "Les TAF donnent des prévisions jusqu'à ___ h?", "réponse" : "30", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "Quand débute la période de validité d'un TAF?", "réponse" : "Au moment ou il sort", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "Un Taf peut sortir jusqu'à combien de temps avant le début de l'heure de prévision?", "réponse" : "30 minutes", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "Quel est la visibilité maximale d'un TAF?", "réponse" : "6 SM", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "FM signife un changement...", "réponse" : "Rapide et permanent", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "BECMG signife un changement...", "réponse" : "Graduel et permanent", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "TEMPO signife un changement...", "réponse" : "temporaire et de courte durée", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "Avec un TEMPO, les changements vont arrivés entre ces heures, mais ne dureront pas plus de ___ h à la fois?", "réponse" : "1", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "Que donne l'ATIS?", "réponse" : "La météo locale, les procédures de départ et d'arrivée, les NOTAM particulier qui touchent l'aéroport et le code de l'ATIS", "indice" : ", ,  et "},
    {"theme" : "TAF_et_ATIS", "question" : "À quoi sert l'ATIS?", "réponse" : "À désencombrer les fréquences", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "Est-ce que l'ATIS est toujours donné sur une autre fréquence?", "réponse" : "Non, il ne l'est pas si les conditions changent trop rapidement", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "Quel sont les critères pour qu'il soit indiqué CAVOK dans l'ATIS?", "réponse" : "Aucun nuage sous 5000 pi ou sous l'altitude minimale la plus haute du secteur, aucun CB, visibilité de 6 SM ou plus et absence de précipitations, d'orage électrique, de brouillard au sol et de poudrerie basse", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "Comment sera indiqué la visibilité dans un TAF si elle est de, par exemple, 10 SM?", "réponse" : "P6SM", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "Est-ce que l'emploi de CAVOK est autorisé dans les TAF?", "réponse" : "Non, sauf dans la section RMK", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "Quels sont les deux moments où les pilotes doivent prendre l'ATIS?", "réponse" : "Au départ et à l'arrivée", "indice" : ""},
    {"theme" : "TAF_et_ATIS", "question" : "Que doit au donner à l'ATC lors du contact initial, après avoir pris l'ATIS?", "réponse" : "Le code de l'ATIS", "indice" : ""},
]

code_aéroport = [
    {"theme" : "code", "question" : "Quel est le code de St-Honoré?", "réponse" : "CYRC", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de Roberval?", "réponse" : "CYRJ", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de Bagotville?", "réponse" : "CYBG", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de Mont-Joli?", "réponse" : "CYRI", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de Sherbrook?", "réponse" : "CYSC", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de Québec?", "réponse" : "CYQB", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de Trois-Rivières?", "réponse" : "CYRQ", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de St-Hubert?", "réponse" : "CYHU", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de Montréal?", "réponse" : "CYUL", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de Mirabel?", "réponse" : "CYMX", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de Ottawa?", "réponse" : "CYOW", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de Gatineau?", "réponse" : "CYND", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de Val d'Or?", "réponse" : "CYVO", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de Rouyn-Noranda?", "réponse" : "CYUY", "indice" : ""},
    {"theme" : "code", "question" : "Quel est le code de Chibougamau?", "réponse" : "CYMT", "indice" : ""},
]
...
fb_fd = [
    ...
    {"theme" : "FBFD", "question" : "Est-ce que les deux premiers chiffres d'un FD peuvent être supérieur à 36?", "réponse" : "Oui", "indice" : ""},
...
categorie = {
    ...
    "metar_et_speci" : metar,
    "TAF_et_ATIS" : taf_atis,
    "code" : code_aéroport,
